...
flash: all 
	@echo "Programming ..."
	@$(ESPTOOL) --port $(ESPPORT) --baud $(ESPBAUD) write_flash --flash_mode dio --flash_size 8m \
	...
	@echo "Firmware Map"
	@echo "boot_v1.6-------------------->\033[0;33m0x00000\033[0m"
	@echo "user1.1024.new.2.bin--------->\033[0;33m0x01000\033[0m"
	@echo "user2.1024.new.2.bin--------->\033[0;33m0x81000\033[0m"
