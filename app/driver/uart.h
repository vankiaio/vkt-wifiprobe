...
#define UART_RX_BUFFER_SIZE 550 //Ring buffer length of rx buffer
...
//==============================================
typedef void (*uart_receive_callback_t)(uint8 data);
void uart_receive_callback_register(uart_receive_callback_t receive_callback);
