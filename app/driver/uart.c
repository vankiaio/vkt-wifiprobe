...
LOCAL uart_receive_callback_t uart_receive_callback_handle = NULL;
 ...
 * Returns      : OK
*******************************************************************************/
STATUS ICACHE_RAM_ATTR uart_tx_one_char(uint8 uart, uint8 TxChar)
{
    while (true) {
 ...
 * Returns      : NONE
*******************************************************************************/
void ICACHE_RAM_ATTR uart1_sendStr_no_wait(const char *str)
{
    while (*str) {
...
//copy uart buffer
LOCAL void ICACHE_RAM_ATTR Uart_Buf_Cpy(struct UartBuffer * pCur, char* pdata , uint16 data_len)
{
...
void ICACHE_RAM_ATTR Uart_rx_buff_enq()
{
...
//--------------------------------
LOCAL void ICACHE_RAM_ATTR tx_fifo_insert(struct UartBuffer * pTxBuff, uint8 data_len,  uint8 uart_no)
{
    uint8 i;
 ...
 * Returns      : NONE
*******************************************************************************/
void ICACHE_RAM_ATTR tx_start_uart_buffer(uint8 uart_no)
{
...
void ICACHE_FLASH_ATTR
uart_receive_callback_register(uart_receive_callback_t receive_callback)
{
    uart_receive_callback_handle = receive_callback;
}
